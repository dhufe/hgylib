...
FIND_PATH( LIBMATIO_INCLUDE_DIR matio.h
               PATHS libs ${QT_INCLUDE_DIR} "${PROJECT_SOURCE_DIR}/deps/matio/include/" "${CMAKE_SOURCE_DIR}/deps/matio/include/" "${CMAKE_SOURCE_DIR}/deps/matio/include/"
               PATH_SUFFIXES matio ENV PATH)
			   
FIND_PATH( LIBMATIO_INCLUDE_BASEDIR matio matio
               PATHS libs ${QT_INCLUDE_DIR} "${PROJECT_SOURCE_DIR}/deps"  "${CMAKE_SOURCE_DIR}/deps"
